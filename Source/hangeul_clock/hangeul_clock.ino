...
/*
 제목 : 6x6 한글 시계 만들기
 내용 : 아두이노 보드를 이용해 1분 단위로 시간을 한글로 표현하는 한글 시계 만들어보기

 kocoafab을 통해 배웠으며, 1분단위로 수정하였습니다.
 소스코드 배포시에는 출처를 남겨주시기 바랍니다.

 다소 소스코드가 최적하지 않은점 안내드립니다.
 
 E mail : lani1105@naver.com
 */
...
void hoursFilter(int hours, int minutes) {
  if (hours == 0) { //00:00
    ...
    strip.setPixelColor(24, color); //오전
  }
  else if (hours == 1) {
    strip.setPixelColor(0, color);
    strip.setPixelColor(17, color); //한시
    strip.setPixelColor(23, color);
    strip.setPixelColor(24, color); //오전
  }
  else if (hours == 2) {
    strip.setPixelColor(1, color);
    strip.setPixelColor(17, color); //두시
    strip.setPixelColor(23, color);
    strip.setPixelColor(24, color); //오전
  }
  else if (hours == 3) {
    strip.setPixelColor(2, color);
    strip.setPixelColor(17, color); //세시
    strip.setPixelColor(23, color);
    strip.setPixelColor(24, color); //오전
  }
  else if (hours == 4) {
    strip.setPixelColor(3, color);
    strip.setPixelColor(17, color); //네시
    strip.setPixelColor(23, color);
    strip.setPixelColor(24, color); //오전
  }
  else if (hours == 5) {
    ...
    strip.setPixelColor(17, color); //다섯시
    strip.setPixelColor(23, color);
    strip.setPixelColor(24, color); //오전
  }
  else if (hours == 6) {
    ...
    strip.setPixelColor(17, color); //여섯시
    strip.setPixelColor(23, color);
    strip.setPixelColor(24, color); //오전
  }
  else if (hours == 7) {
    ...
    strip.setPixelColor(17, color); //일곱시
    strip.setPixelColor(23, color);
    strip.setPixelColor(24, color); //오전
  }
  else if (hours == 8) {
    ...
    strip.setPixelColor(17, color); //여덟시
    strip.setPixelColor(23, color);
    strip.setPixelColor(24, color); //오전
  }
  else if (hours == 9) {
    ...
    strip.setPixelColor(17, color); //아홉시
    strip.setPixelColor(23, color);
    strip.setPixelColor(24, color); //오전
  }
  else if (hours == 10) {
    strip.setPixelColor(14, color);
    strip.setPixelColor(17, color); //열시
    strip.setPixelColor(23, color);
    strip.setPixelColor(24, color); //오전
  }
  else if (hours == 11) {
    ...
    strip.setPixelColor(17, color); //열한시
    strip.setPixelColor(23, color);
    strip.setPixelColor(24, color); //오전
  }
  else if (hours == 12) {
      strip.setPixelColor(23, color);
      strip.setPixelColor(35, color); //오후
      strip.setPixelColor(14, color);
      strip.setPixelColor(16, color);
      strip.setPixelColor(17, color); //열두시
  }
  else if (hours == 13) {
    strip.setPixelColor(0, color); // 한시
    strip.setPixelColor(17, color);
    strip.setPixelColor(23, color); //오후
    strip.setPixelColor(35, color); 
  }
  else if (hours == 14) {
    strip.setPixelColor(1, color); // 두시
    strip.setPixelColor(17, color);
    strip.setPixelColor(23, color); //오후
    strip.setPixelColor(35, color); 
  }
  else if (hours == 15) {
    strip.setPixelColor(2, color); // 세시
    strip.setPixelColor(17, color);
    strip.setPixelColor(23, color); //오후
    strip.setPixelColor(35, color); 
  }
  else if (hours == 16) {
    strip.setPixelColor(3, color); // 네시
    strip.setPixelColor(17, color);
    strip.setPixelColor(23, color); //오후
    strip.setPixelColor(35, color); 
  }
  else if (hours == 17) {
    strip.setPixelColor(4, color); // 다섯시
    strip.setPixelColor(5, color); 
    strip.setPixelColor(17, color);
    strip.setPixelColor(23, color); //오후
    strip.setPixelColor(35, color); 
    ...
    strip.setPixelColor(16, color);
    strip.setPixelColor(17, color); //열두시
    strip.setPixelColor(23, color); //오전
